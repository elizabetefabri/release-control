...
| Environment | Host                                                           |
| ----------- | -------------------------------------------------------------- |
| local       | [http://localhost:8083/v1](http://localhost:8083/v1)           |
| dev         | [http://localhost-dev:8083/v1](http://localhost-dev:8083/v1)   |
| hom         | [http://localhost-hom:8083/v1](http://localhost-hom:8083/v1)   |
| prod        | [http://localhost-prod:8083/v1](http://localhost-prod:8083/v1) |
|             |                                                                |
